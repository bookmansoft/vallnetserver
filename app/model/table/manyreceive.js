...
//建立数据库ORM模型
let ManyReceive = (db, sa, pwd) => seqconn.seqConnector(db, sa, pwd).define(
    'ManyReceive',
    {
        ...
        //     `send_openid` varchar(255) NOT NULL COMMENT '发送人openid，冗余用于查询',
        //     `send_nickname` varchar(255) NOT NULL COMMENT '发送人昵称，冗余用于查询',
        //     `send_headimg` varchar(255) NOT NULL COMMENT '头像',
        //     `receive_openid` varchar(255) DEFAULT NULL COMMENT '接收人openid',
        ...
        send_openid: Sequelize.STRING,
        send_nickname: Sequelize.STRING,
        send_headimg: Sequelize.STRING,
        receive_openid: Sequelize.STRING,
