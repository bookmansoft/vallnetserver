...
class account extends facade.Control {
    ...
    async List(user, paramGold) {
        try {
            ...
            let ret = await this.core.service.RemoteNode.conn(user.openid).execute('account.list', paramArray);
            console.log(ret);
    ...
    async Get(user, paramGold) {
        try {
            ...
            console.log(paramArray);
            let ret = await this.core.service.RemoteNode.conn(user.openid).execute('account.get', paramArray);
            console.log(ret);
            //return { code: ReturnCode.Success, data: ret };
            return { code: ret.code, data: ret.result };
        } catch (error) {
    ...
    async Create(user, paramGold) {
        try {
            ...
            console.log(paramArray);
            let ret = await this.core.service.RemoteNode.conn(user.openid).execute('account.create', paramArray);
            console.log(ret);
            //return { code: ReturnCode.Success, data: ret };
            return { code: ret.code, data: ret.result };
        } catch (error) {
    ...
    async Amount(user, paramGold) {
        try {
            ...
            console.log(paramArray);
            let ret = await this.core.service.RemoteNode.conn(user.openid).execute('account.amount', paramArray);
            console.log(ret);
            //return { code: ReturnCode.Success, data: ret };
            return { code: ret.code, data: ret.result };
        } catch (error) {
    ...
    async Received(user, paramGold) {
        try {
            ...
            console.log(paramArray);
            let ret = await this.core.service.RemoteNode.conn(user.openid).execute('account.received', paramArray);
            console.log(ret);
            //return { code: ReturnCode.Success, data: ret };
            return { code: ret.code, data: ret.result };
        } catch (error) {
    ...
    async ListReceived(user, paramGold) {
        try {
            ...
            console.log(paramArray);
            let ret = await this.core.service.RemoteNode.conn(user.openid).execute('account.listreceived', paramArray);
            console.log(ret);
            //return { code: ReturnCode.Success, data: ret };
            return { code: ret.code, data: ret.result };
        } catch (error) {
    ...
    async BalanceConfirmed(user, paramGold) {
        try {
            ...
            console.log(paramArray);
            let ret = await this.core.service.RemoteNode.conn(user.openid).execute('balance.confirmed', paramArray);
            console.log(ret);
            //return { code: ReturnCode.Success, data: ret };
            return { code: ret.code, data: ret.result };
        } catch (error) {
    ...
    async BalanceAll(user, paramGold) {
        try {
            ...
            console.log(paramArray);
            let ret = await this.core.service.RemoteNode.conn(user.openid).execute('balance.all', paramArray);
            console.log(ret);
            //return { code: ReturnCode.Success, data: ret };
            return { code: ret.code, data: ret.result };
        } catch (error) {
    ...
    async BalanceUnconfirmed(user, paramGold) {
        try {
            ...
            console.log(paramArray);
            let ret = await this.core.service.RemoteNode.conn(user.openid).execute('balance.unconfirmed', paramArray);
            console.log(ret);
            //return { code: ReturnCode.Success, data: ret };
            return { code: ret.code, data: ret.result };
        } catch (error) {
