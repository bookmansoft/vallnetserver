 ...
 * 自定义认证接口
 */
class authofficial extends facade.Control
{
    constructor(parent) {
        super(parent);
        this.domain = 'authwx';
    ...
    async check(oemInfo) {
        //模拟用户注册表
        let User = {
            'bookman': this.parent.service.gamegoldHelper.remote.hash256('hello').toString('base64'),
        }
...
exports = module.exports = authofficial;
